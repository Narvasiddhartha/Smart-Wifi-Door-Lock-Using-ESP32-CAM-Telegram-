...
const char* ssid = "P0C0 M4 Pro";  //WiFi Name
const char* password = "pravallika123";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "6014249456";
String BOTtoken = "7299357743:AAFEsXkp1lB51G6oz-UwWHlHBesWDF3OJg8";
